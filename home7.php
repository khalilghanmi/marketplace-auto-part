...
<head>
    ...
    <link href="css/footer/footer7.css" rel="stylesheet">
    <link href="css/header/header7.css" rel="stylesheet">
...
<body class="common-home res layout-7">
    
    <div id="wrapper" class="wrapper-fluid banners-effect-3">
    

    <!-- Header Container  -->
    <header id="header" class="typeheader-7">
        ...
        <div class="header-bottom hidden-compact">
            <div class="container">
                <div class="row">           
                    <div class="logo-w col-lg-3 col-md-3 col-sm-4 col-xs-7">
                        <div class="logo">
                            <a href="index.php"><img src="image/catalog/logo.png" title="Your Store" alt="Your Store" /></a>
                        </div>                        
                    </div>
                    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-5 middle-right">
    ...
    <div id="content">
        <div class="custom-cates">
            <div class="yt-content-slider contentslider" data-rtl="no" data-loop="yes" data-autoplay="no" data-autoheight="no" data-autowidth="no" data-delay="4" data-speed="0.6" data-margin="0" data-items_column00="4" data-items_column0="4" data-items_column1="3" data-items_column2="2" data-items_column3="2" data-items_column4="1" data-arrows="no" data-pagination="no" data-lazyload="yes" data-hoverpause="yes">
                <div class="item">
                    <a href="#" class="img">
                        <img src="image/catalog/banners/ca1.jpg" alt="banner">
                    </a>
                    <div class="cont">
                        <h2>Body parts</h2>
                ...
                <div class="item">
                    <a href="#" class="img">
                        <img src="image/catalog/banners/ca2.jpg" alt="banner">
                    </a>
                    <div class="cont">
                        <h2>Light parts</h2>
                ...
                <div class="item">
                    <a href="#" class="img">
                        <img src="image/catalog/banners/ca3.jpg" alt="banner">
                    </a>
                    <div class="cont">
                        <h2>Repair parts</h2>
                ...
                <div class="item">
                    <a href="#" class="img">
                        <img src="image/catalog/banners/ca4.jpg" alt="banner">
                    </a>
                    <div class="cont">
        ...
        <div class="content-main container">
            <div class="module listingtab-layout7">
                    ...
                    <div id="so_listing_tabs_4" class="so-listing-tabs first-load">
                        ...
                        <div class="ltabs-wrap">
                            <div class="ltabs-tabs-container" data-delay="300" data-duration="600" data-effect="none" data-ajaxurl="" data-type_source="0" data-lg="4" data-md="4" data-sm="3" data-xs="1" data-margin="30" data-type_show="loadmore">
                                ...
                                <span class="ltabs-tab-selected">New Arrivals</span> <span class="ltabs-tab-arrow">▼</span>
                                    <div class="item-sub-cat">
                                        <ul class="ltabs-tabs cf">
                                            <li class="ltabs-tab tab-sel" data-category-id="34" data-active-content=".items-category-34"> <span class="ltabs-tab-label">New Arrivals</span> </li>
                                            <li class="ltabs-tab " data-category-id="32" data-active-content=".items-category-32"> <span class="ltabs-tab-label">Best Seller</span> </li>
                                            <li class="ltabs-tab " data-category-id="33" data-active-content=".items-category-33"> <span class="ltabs-tab-label">Featured</span> </li>
                                        </ul>
                                    </div>
                                </div>
                                <!-- End Tabs-->
                                            ...
                                            <div class="item">
                                                ...
                                                <div class="product-layout product-grid">                                                
                                                    <div class="product-item-container item--static">
                                                        <div class="left-block">
                                                            <div class="product-image-container second_img">
                                                                <a href="product.php" target="_self" title="Luis rute arure">
                                                        ...
                                                        <div class="right-block">
                                                            ...
                                                            <h4><a href="product.php" title="Luis rute arure" target="_self">Luis rute arure</a></h4>
                                                            <div class="rating">    <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                                                <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                                                <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                                                <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                                ...
                                                <div class="product-layout product-grid">                                                 
                                                    <div class="product-item-container item--static">
                                                        ...
                                                        <div class="right-block">
                                                            ...
                                                            <h4><a href="product.php" title="Sunt in culpa" target="_self">Sunt in culpa</a></h4>
                                                            <div class="rating">    <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                                                <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                                                <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
                                                                <span class="fa fa-stack"><i class="fa fa-star fa-stack-2x"></i></span>
            ...
            <a class="home7-video" href="https://www.youtube.com/watch?v=92lJSTQXaZk">
                <div class="box-video">video</div>
            </a>
            ...
            <div class="module extra-layout7">
                ...
                <h3 class="modtitle"><span>Special offers</span></h3>
                <div class="modcontent">
    ...
    <footer class="footer-container typefooter-7">
        <div class="row-dark">
            <div class="module newsletter-footer7 container">
                <div class="newsletter">
                    <h3 class="modtitle">Sign Up For Newsletter & Get 20% Off On First Order</h3>
        ...
        <div class="container footer-middle">
            <div class="content-footer">
                ...
                <p>Autoparts a local Sudbury florist has served the Los Angeles  area since 2009. When you work with Autoparts, you'll immediately
            see why the SmartAddons family has a reputation for delivering quality, value and service.</p>
                <ul class="socials">
            ...
            <div class="footer-links">
                <ul>
                    ...
                    <li><a href="index.php?route=extension/simple_blog/article">Our Blog</a></li>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <div class="payment-w col-lg-12 col-md-12 col-sm-12 col-xs-12">
