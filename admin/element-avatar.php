                        ...
                        <div id="avatarTooltip" class="col-lg-12 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area image-style-content text-center">
                                    ...
                                    <div class="avatar--group">
                                        <div class="avatar avatar-sm">
                                            <img alt="avatar" src="../src/assets/img/profile-16.jpeg" class="rounded-circle  bs-tooltip" data-bs-original-title="Lisa" />
                                        </div>
                                        <div class="avatar avatar-sm">
                                            <img alt="avatar" src="../src/assets/img/delete-user-4.jpeg" class="rounded-circle  bs-tooltip" data-bs-original-title="Mary" />
                                        </div>
                                        <div class="avatar avatar-sm">
                                            <img alt="avatar" src="../src/assets/img/profile-5.jpeg" class="rounded-circle  bs-tooltip" data-bs-original-title="Andy" />
                                        </div>
                                        <div class="avatar avatar-sm">
                            ...
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area image-style-content text-center">
                                    ...
                                    <span class="avatar-chip bg-primary mb-2 me-4 position-relative">
                                        <img src="../src/assets/img/profile-2.jpeg" alt="Person" width="96" height="96">
                                    ...
                                    <span class="avatar-chip bg-info mb-2 me-4 position-relative">
                                        <img src="../src/assets/img/profile-16.jpeg" alt="Person" width="96" height="96">
                                        <span class="text">Lisa</span>
                                    </span>

                                    <span class="avatar-chip bg-danger mb-2 me-4">
                                        <img src="../src/assets/img/profile-5.jpeg" alt="Person" width="96" height="96">
                                        <span class="text">Andy</span>
                                    </span>

                                    <span class="avatar-chip bg-warning mb-2 me-4 position-relative">
                                        <img src="../src/assets/img/profile-12.jpeg" alt="Person" width="96" height="96">
                                    ...
                                    <span class="avatar-chip bg-dark mb-2 me-4">
                                        <img src="../src/assets/img/profile-1.jpeg" alt="Person" width="96" height="96">
