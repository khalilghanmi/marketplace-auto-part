...
<body class="mobile-home ltr mobilelayout-0">
	<!-- Begin Main wrapper -->
    <div id="wrapper" >
		...
		<!-- Begin Bar Nav -->
		<header class="bar bar-nav bar-navhome typeheader-0">
										...
										<div class="so-homeslider contentslider" data-rtl="no" data-autoplay="no" data-autowidth="no" data-delay="4" data-speed="0.6" data-margin="0" data-item_xs="1" data-item_sm="1" data-arrows="no" data-pagination="yes" data-lazyload="no"  data-loop="yes" data-hoverpause="yes">
											...
											<div class="item ">
												<a href="#" title="slider3" target="_self">
													<img class="responsive" src="../image/demo-mobile/slider/banner-mobile-2.jpg" alt="slider3">
												</a>
												<div class="sohomeslider-description"></div>
											</div>
											<div class="item ">
												<a href="#" title="slider1" target="_self">
													<img class="responsive" src="../image/demo-mobile/slider/banner-mobile-3.jpg" alt="slider1">
												</a>
												<div class="sohomeslider-description"></div>
											</div>
										</div>
						...
						<div class="col-xs-12 no-padding">
							<div class="mobile-bn1-h1 clearfix">
								<div class="banners">
									<div class="banner21">
										<a href="#">
											<img src="../image/demo-mobile/banner/banner-mobile-2.png" alt="Image Client">
										</a>
									</div>
									<div class="banner21">
										<a href="#">
											<img src="../image/demo-mobile/banner/banner-mobile-3.png" alt="Image Client">
										</a>
									</div>
								</div>
							</div>
								...
								<div class="block-categories">
									...
									<div class="cate-content contentslider" data-rtl="no" data-autoplay="no" data-autowidth="yes" data-delay="4" data-speed="0.6" data-margin="10" data-col-xs="1" data-col-sm="1" data-arrows="yes" data-pagination="no" data-lazyload="no" data-loop="yes" data-hoverpause="yes">
										<div class="cate cate1">
											<div class="inner"><img src="../image/demo-mobile/banner/home1/cate1.jpg" alt="Static Image"><a href="#">Watch</a></div>
										</div>
										<div class="cate cate2">
										<div class="inner"><img src="../image/demo-mobile/banner/home1/cate2.jpg" alt="Static Image"><a href="#">Bags</a></div>
										</div>
										<div class="cate cate3">
										<div class="inner"><img src="../image/demo-mobile/banner/home1/cate3.jpg" alt="Static Image"><a href="#">Swimwear</a></div>
										</div>
										<div class="cate cate4">
										<div class="inner"><img src="../image/demo-mobile/banner/home1/cate4.jpg" alt="Static Image"><a href="#">Shoes</a></div>
										</div>
										<div class="cate cate5">
										<div class="inner"><img src="../image/demo-mobile/banner/home1/cate5.jpg" alt="Static Image"><a href="#">Fashion</a></div>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-xs-12 no-padding">
							<div class="mobile-bn1-h1 clearfix">
								<div class="banners">
									<div class="banner21">
										<a href="#">
											<img src="../image/demo-mobile/banner/banner-mobile-5.png" alt="Image Client">
										</a>
									</div>
									<div class="banner21">
										<a href="#">
											<img src="../image/demo-mobile/banner/banner-mobile-6.png" alt="Image Client">
										</a>
									</div>
								</div>
							</div>
							...
							<div class=" module">
								...
								<div class="contentslider" data-rtl="no" data-autoplay="no" data-autowidth="yes" data-delay="4" data-speed="0.6" data-margin="10" data-col-xs="1" data-col-ms="1"  data-arrows="yes" data-pagination="no" data-lazyload="no" data-loop="yes" data-hoverpause="yes">
									<div class="item-brand item-scroll">
										<a href="#">
											<img src="../image/demo-mobile/banner/brand-mobile.jpg" alt="Image Client">
										</a>
									</div>
									<div class="item-brand item-scroll">
										<a href="#">
