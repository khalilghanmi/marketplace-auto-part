<div class="modal fade bd-example-modal-lg" id="empModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form class="row g-3" method="post" action="controller/Categories-Produits/modifications.php"  enctype="multipart/form-data">
                                    ...
                                    <div class="modal fade bd-example-modal-lg" id="empModalestatut" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    Modification Statut
