								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<fieldset id="address" class="required">
											...
											<div class="checkbox">
												<label>
													<input type="checkbox" checked="checked" value="1" name="shipping_address"> My delivery and billing addresses are the same.</label>
											</div>
										</fieldset>
									</div>
								</div>
														...
														<tbody>
															<tr>
																<td class="text-center">
																	<a href="product.php"><img width="100px" src="../image/demo-mobile/product/e12.jpg" alt="Xitefun Causal Wear Fancy Shoes" title="Xitefun Causal Wear Fancy Shoes" class="img-thumbnail">
																	</a>
																</td>
																<td class="text-left"><a href="product.php">Emasa rumas gacem</a>
																</td>
																<td class="text-left">
