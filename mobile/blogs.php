						...
						<div class="blog-listitem grid">
							<div class="blog-item col-md-6 col-sm-6">
								...
								<div class="itemBlogContent right-block col-sm-12">
									...
									<!-- COMMENT -->
									<div class="blog-meta">
										<span class="author"><i class="fa fa-user"></i><span>Post by </span>Admin</span>
							...
							<div class="blog-item col-md-6 col-sm-6">
								...
								<div class="itemBlogContent right-block col-sm-12">
									...
									<div class="blog-meta">
										<span class="author"><i class="fa fa-user"></i><span>Post by </span>Admin</span>
										<span class="comment_count"><i class="fa fa-comments"></i><a href="#">2 Comments</a></span>
									</div>
							...
							<div class="blog-item col-md-6 col-sm-6">
								...
								<div class="itemBlogContent right-block col-sm-12">
									...
									<div class="blog-meta">
										<span class="author"><i class="fa fa-user"></i><span>Post by </span>Admin</span>
										<span class="comment_count"><i class="fa fa-comments"></i><a href="#">5 Comments</a></span>
									</div>
							...
							<div class="blog-item col-md-6 col-sm-6">
								...
								<div class="itemBlogContent right-block col-sm-12">
									...
									<div class="blog-meta">
										<span class="author"><i class="fa fa-user"></i><span>Post by </span>Admin</span>
										<span class="comment_count"><i class="fa fa-comments"></i><a href="#">0 Comments</a></span>
									</div>
