...
<body class="ltr mobilelayout-0">
    ...
    <div id="wrapper" >
		...
		<header class="bar bar-nav ">
			...
			<h1 class="title">Aestibulum ipsum a ornare car</h1>
		</header>
		<!-- //End Bar Nav -->
						...
						<div class="rows form-group">
							<div class="article-info">
								...
								<div class="article-image">
									<img src="../image/demo-mobile/blog/4.jpg" alt="Aestibulum ipsum a ornare car">
								</div>
								<!-- TITLE -->
								<div class="article-sub-title">
									<span class="article-author"><a href="#">Post by: Admin</a></span>
									<span class="article-date">Created Date: <b>24</b> Feb</span>
									<span class="article-comment">0  Comments</span>
								</div>
								
								<div class="article-title">
									<h3>Aestibulum ipsum a ornare car</h3>
								</div>
								<!-- DESCRIP -->
								<div class="article-description" style="clear: both;">
									<p><span >Morbi tempus, non ullamcorper euismod, erat odio suscipit purus, nec ornare lacus turpis ac purus. Mauris cursus in mi vel dignissim. Morbi mollis elit ipsum, a feugiat lectus gravida non. Aenean molestie justo sed aliquam euismod. Maecenas laoreet bibendum laoreet. Morbi tempor massa sit amet purus lobortis, non porta tellus dignissim. Proin dictum justo a nisl pellentesque egestas.Nulla commodo euismod nisi ac bibendum. Mauris in pellentesque tellus, in cursus magna. </p>
									
									<p>Sed volutpat dui bibendum mi molestie, at volutpat nunc dictum. Fusce sagittis massa id eros scelerisque, eget accumsan magna lacinia. Nullam posuere neque at neque dictum interdum</span>
											...
											<div id="comments" class="blog-comment-info">
												<div id="comment-list">
													<div class="media comments">
														<a class="pull-left" href="#"> <i class="fa fa-comment-o" aria-hidden="true"></i>
														</a>
														<div class="media-body">
															<div class="media-title">
																<a id="comment_reply" class="pull-right label label-info" onclick="setArticleId(6);">Reply</a>
																<span class="username">by <b>Kelnguyen</b></span>
																<div class="time"><i class="fa fa-clock-o" aria-hidden="true"></i>October 8th, 2015 11:32 PM</div>
															</div>
													...
													<div class="media comments">
														...
														<div class="media-body">
															<div class="media-title">
																<a id="comment_reply" class="pull-right label label-info" onclick="setArticleId(4);">Reply</a>
																<span class="username">by <b>Kelnguyen</b></span>
																<div class="time"><i class="fa fa-clock-o" aria-hidden="true"></i>October 8th, 2015 11:31 PM</div>
															</div>
															<div class="media-content">
																<p>At vero eos et accusam et justo duo dolores et ea rebum</p>
															</div>
													...
													<div class="media comments comments-level-1">
														...
														<div class="media-body">
															<div class="media-title">
																<span class="username">by <b>Kelnguyen</b></span>
																<div class="time"><span class="icon icon-access_time"></span>October 8th, 2015 11:32 PM</div>
															</div>
															<div class="media-content">
																<p>At vero eos et accusam et justo duo dolores et ea rebum</p>
															</div>
													...
													<div class="form-group clearfix">
														...
														<div class="col-xs-12 text-center">Showing 1 to 2 of 2 (1 Pages)</div>
													</div>
												...
												<hr>
												<h2 id="review-title">Leave your comment        											</h2>
												...
												<div class="text-left"><a id="button-comment" class="btn btn-info"><span>LEAVE A COMMENT</span></a>
												</div>
											</div>
										</div>
									</div>
