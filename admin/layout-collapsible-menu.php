...
<head>
    ...
    <title>Semi-Dark Menu | CORK - Multipurpose Bootstrap Dashboard Template </title>
                    ...
                    <div class="row layout-top-spacing">
                        ...
                        <div class="col-12">
                            <div class="alert alert-arrow-right alert-icon-right alert-light-success alert-dismissible fade show mb-4" role="alert">
                                ...
                                <strong>Kick Start you new project with ease!</strong> Learn more about Starter Kit by refering to the <a target="_blank" href="https://designreset.com/cork/documentation/getting-started.php">Documentation</a>
                            </div>
                        </div>
