...
<head>
    ...
    <title>Dragula Drag and Drop | CORK - Multipurpose Bootstrap Dashboard Template </title>
    ...
    <link href="../src/plugins/src/drag-and-drop/dragula/dragula.css" rel="stylesheet" type="text/css" />
    <link href="../src/plugins/css/light/drag-and-drop/dragula/example.css" rel="stylesheet" type="text/css" />
    <link href="../src/plugins/css/dark/drag-and-drop/dragula/example.css" rel="stylesheet" type="text/css" />
...
<body class="layout-boxed ">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div id='left-defaults' class='dragula'>
                                                    ...
                                                    <div class="media  d-md-flex d-block">
                                                        <img alt="avatar" src="../src/assets/img/profile-2.jpeg" class="img-fluid ">
                                                        <div class="media-body">
                                                    ...
                                                    <div class="media  d-md-flex d-block">
                                                        <img alt="avatar" src="../src/assets/img/profile-3.jpeg" class="img-fluid ">
                                                        <div class="media-body">
                                                            <div class="d-xl-flex d-block justify-content-between">
                                                                <div class="">
                                                    ...
                                                    <div class="media  d-md-flex d-block">
                                                        <img alt="avatar" src="../src/assets/img/profile-4.jpeg" class="img-fluid ">
                                                        <div class="media-body">
                                                            <div class="d-xl-flex d-block justify-content-between">
                                                                <div class="">
                                                    ...
                                                    <div class="media  d-md-flex d-block">
                                                        <img alt="avatar" src="../src/assets/img/profile-5.jpeg" class="img-fluid ">
                                                        <div class="media-body">
                                                            <div class="d-xl-flex d-block justify-content-between">
                                                                <div class="">
                                                    ...
                                                    <div class="media  d-md-flex d-block">
                                                        <img alt="avatar" src="../src/assets/img/profile-6.jpeg" class="img-fluid ">
                                                        <div class="media-body">
                                                            <div class="d-xl-flex d-block justify-content-between">
                                                                <div class="">
                                            ...
                                            <div class="col-sm-6">
                                                <div id='right-defaults' class='dragula'>
                                                    <div class="media  d-md-flex d-block">
                                                        <img alt="avatar" src="../src/assets/img/profile-7.jpeg" class="img-fluid ">
                                                        <div class="media-body">
                                                            <div class="d-xl-flex d-block justify-content-between">
                                                                <div class="">
                                                                    <h6 class="">Need to be approved</h6>
                                                    ...
                                                    <div class="media  d-md-flex d-block">
                                                        <img alt="avatar" src="../src/assets/img/profile-8.jpeg" class="img-fluid ">
                                                        <div class="media-body">
                                                            <div class="d-xl-flex d-block justify-content-between">
                                                                <div class="">
                                                                    <h6 class="">Meeting with client</h6>
                                                    ...
                                                    <div class="media  d-md-flex d-block">
                                                        <img alt="avatar" src="../src/assets/img/profile-9.jpeg" class="img-fluid ">
                                                        <div class="media-body">
                                                            <div class="d-xl-flex d-block justify-content-between">
                                                                <div class="">
                                                                    <h6 class="">Project Detail</h6>
                                                    ...
                                                    <div class="media  d-md-flex d-block">
                                                        <img alt="avatar" src="../src/assets/img/profile-10.jpeg" class="img-fluid ">
                                                        <div class="media-body">
                                                            <div class="d-xl-flex d-block justify-content-between">
                                                                <div class="">
                                                                    <h6 class="">Edited Post Apporval</h6>
                                                    ...
                                                    <div class="media  d-md-flex d-block">
                                                        <img alt="avatar" src="../src/assets/img/profile-11.jpeg" class="img-fluid ">
                                                        <div class="media-body">
                                                            <div class="d-xl-flex d-block justify-content-between">
                                                                <div class="">
                                                                    <h6 class="">Project Lead Pickup</h6>
                                        ...
                                        <div class='row'>
                                            ...
                                            <div class="col-md-6">
                                                <div id='left-events' class='dragula'>
                                                    <div class="media   d-block d-sm-flex">
                                                        <img alt="avatar" src="../src/assets/img/profile-16.jpeg" class="img-fluid ">
                                                        <div class="media-body">
                                                    ...
                                                    <div class="media   d-block d-sm-flex">
                                                        <img alt="avatar" src="../src/assets/img/drag-4.jpg" class="img-fluid ">
                                                        <div class="media-body">
                                                            <div class="d-flex justify-content-between">
                                                                <div class="">
                                                    ...
                                                    <div class="media   d-block d-sm-flex">
                                                        <img alt="avatar" src="../src/assets/img/profile-26.jpeg" class="img-fluid ">
                                                        <div class="media-body">
                                                            <div class="d-flex justify-content-between">
                                                                <div class="">
                                                    ...
                                                    <div class="media   d-block d-sm-flex">
                                                        <img alt="avatar" src="../src/assets/img/g-7.png" class="img-fluid ">
                                                        <div class="media-body">
                                                            <div class="d-flex justify-content-between">
                                                                <div class="">
                                                    ...
                                                    <div class="media   d-block d-sm-flex">
                                                        <img alt="avatar" src="../src/assets/img/drag-2.jpeg" class="img-fluid ">
                                                        <div class="media-body">
                                                            <div class="d-flex justify-content-between">
                                                                <div class="">
                                            ...
                                            <div class="col-md-6">
                                                <div id='right-events' class='dragula'>
                                                    <div class="media   d-block d-sm-flex">
                                                        <img alt="avatar" src="../src/assets/img/p7.jpeg" class="img-fluid ">
                                                        <div class="media-body">
                                                            <div class="d-flex justify-content-between">
                                                                <div class="">
                                                    ...
                                                    <div class="media   d-block d-sm-flex">
                                                        <img alt="avatar" src="../src/assets/img/drag-1.jpeg" class="img-fluid ">
                                                        <div class="media-body">
                                                            <div class="d-flex justify-content-between">
                                                                <div class="">
                                                    ...
                                                    <div class="media   d-block d-sm-flex">
                                                        <img alt="avatar" src="../src/assets/img/g-8.png" class="img-fluid ">
                                                        <div class="media-body">
                                                            <div class="d-flex justify-content-between">
                                                                <div class="">
                                                    ...
                                                    <div class="media   d-block d-sm-flex">
                                                        <img alt="avatar" src="../src/assets/img/p9.jpeg" class="img-fluid ">
                                                        <div class="media-body">
                                                            <div class="d-flex justify-content-between">
                                                                <div class="">
                                                    ...
                                                    <div class="media   d-block d-sm-flex">
                                                        <img alt="avatar" src="../src/assets/img/p6.jpeg" class="img-fluid ">
                                                        <div class="media-body">
                                                            <div class="d-flex justify-content-between">
                                                                <div class="">
                                        ...
                                        <div class='row'>
                                            ...
                                            <div class="col-md-6">
                                                <div id='left-rm-spill' class='dragula'>
                                                    <div class="media d-block d-sm-flex">
                                                        <img class="" src="../src/assets/img/delete-user-15.jpeg" alt="avatar">
                                                        <div class="media-body">
                                                    ...
                                                    <div class="media d-block d-sm-flex">
                                                        <img class="" src="../src/assets/img/delete-user-4.jpeg" alt="avatar">
                                                        <div class="media-body">
                                                    ...
                                                    <div class="media d-block d-sm-flex">
                                                        <img class="" src="../src/assets/img/delete-user-11.jpeg" alt="avatar">
                                                        <div class="media-body">
                                            ...
                                            <div class="col-md-6">
                                                <div id='right-rm-spill' class='dragula'>
                                                    <div class="media d-block d-sm-flex">
                                                        <img class="" src="../src/assets/img/delete-user-12.jpeg" alt="avatar">
                                                        <div class="media-body">
                                                    ...
                                                    <div class="media d-block d-sm-flex">
                                                        <img class="" src="../src/assets/img/delete-user-16.jpeg" alt="avatar">
                                                        <div class="media-body">
                                                    ...
                                                    <div class="media d-block d-sm-flex">
                                                        <img class="" src="../src/assets/img/delete-user-17.jpeg" alt="avatar">
                                                        <div class="media-body">
    ...
    <script src="../src/plugins/src/drag-and-drop/dragula/dragula.min.js"></script>
    <script src="../src/plugins/src/drag-and-drop/dragula/custom-dragula.js"></script>
