						...
						<tbody>
							<tr>
								<td class="text-center">
									<a  href="product.php"><img width="70px" src="image/catalog/demo/product/80/2.jpg" alt="Aspire Ultrabook Laptop" title="Aspire Ultrabook Laptop">
									</a>
								</td>
								<td class="text-left"><a href="product.php">iPad</a>
								</td>
							...
							<tr>
								<td class="text-center">
									<a href="product.php"><img width="70px" src="image/catalog/demo/product/80/1.jpg" alt="Xitefun Causal Wear Fancy Shoes" title="Xitefun Causal Wear Fancy Shoes"></a>
								</td>
								<td class="text-left"><a href="product.php">Comas samer rumas</a>
								</td>
