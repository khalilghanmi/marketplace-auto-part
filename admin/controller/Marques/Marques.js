...
$(function(){
                $('#gi').click(function(){
                    ...
                    $.post('controller/Marques/ajouter.php',da,function(data){
                        if(data == ""){
                            ...
                            setTimeout(
                            window.location.replace("Liste-des-Marques.php"), 10000);;  
                        }
                    else {
                        $('#alerte').html(data);
                    }
                ...
                $('#modif').click(function(){
                    ...
                    $.post('controller/Marques/modifications.php',da,function(data){
                        if(data == ""){
