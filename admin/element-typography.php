...
<head>
    ...
    <link href="../src/assets/css/light/elements/custom-typography.css" rel="stylesheet" type="text/css" />
    <link href="../src/assets/css/dark/elements/custom-typography.css" rel="stylesheet" type="text/css" />
                                    ...
                                    <div class="row">
                                        <div class="col-xl-9 mx-auto">
                                            <div class="element-background">
                                                ...
                                                <p>You can use the mark tag to <mark class="bg-primary br-8">highlight</mark> text. ( <span><code>mark</code> tag with <code>.bg-primary</code></span> )</p>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-9 mx-auto">
                                            <blockquote class="blockquote media-object">
                                                <div class="media">
                                                    <div class="usr-img me-2">
                                                        <img alt="avatar" src="../src/assets/img/profile-16.jpeg" class="br-30">
                                                    </div>
