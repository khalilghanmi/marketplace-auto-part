						  ...
						  <div class="panel-body">
							<div class="table-responsive">
							  <table class="table table-bordered">
								...
								<tbody>
								  <tr>
									<td class="text-center"><a href="product.php"><img width="60px" src="image/catalog/demo/product/replacement/10.jpg" alt="Xitefun Causal Wear Fancy Shoes" title="Xitefun Causal Wear Fancy Shoes" class="img-thumbnail"></a></td>
									<td class="text-left"><a href="product.php">Emasa rumas gacem</a></td>
