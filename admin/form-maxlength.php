...
$(selector).maxlength({
    ...
    <script src="../src/plugins/src/bootstrap-maxlength/bootstrap-maxlength.js"></script>
    <script src="../src/plugins/src/bootstrap-maxlength/custom-bs-maxlength.js"></script>
