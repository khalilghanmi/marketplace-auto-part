...
<body class="mobile-home ltr mobilelayout-2">
	<!-- Begin Main wrapper -->
    <div id="wrapper" >
		...
		<!-- Begin Bar Nav -->
		<header class="bar bar-nav bar-navhome typeheader-2">
			<div class=" navbar-bar ">
				...
				<div class="navbar-logo">
					<a href="index.php"><img src="../image/demo-mobile/logo.png" title="Your Store - Layout3 " alt="Your Store - Layout3 "></a>
				</div>
				<div class="header-link pull-right">
					<div class="header-wishlist">
						<a href="#" id="wishlist-total" class="top-link-wishlist" title="Wish List (0)"><span class="fa fa-heart-o"></span></a>
					</div>
					...
					<div id="content" >
										...
										<div class="so-homeslider contentslider" data-rtl="no" data-autoplay="no" data-autowidth="no" data-delay="4" data-speed="0.6" data-margin="0" data-item_xs="1" data-item_sm="1" data-arrows="no" data-pagination="yes" data-lazyload="no"  data-loop="no" data-hoverpause="yes">
											<div class="item ">
												<a href="index.php" title="slider2" target="_self">
													<img class="responsive" src="../image/demo-mobile/slider/home3/slider3-1.jpg" alt="slider1">
												</a>
											</div>
											<div class="item ">
												<a href="index.php" title="slider2" target="_self">
													<img class="responsive" src="../image/demo-mobile/slider/home3/slider3-2.jpg" alt="slider2">
												</a>
											</div>
										</div>
						...
						<div class="col-xs-12 ">
							<div class="mobile-bn1-h1 clearfix">
								<div class="banners">
									<div class="banner21">
										<a href="#">
											<img src="../image/demo-mobile/banner/home3/banner-home32.jpg" alt="Image Client">
										</a>
									</div>
									<div class="banner21">
										<a href="#">
											<img src="../image/demo-mobile/banner/home3/banner-home33.jpg" alt="Image Client">
										</a>
									</div>
								</div>
							</div>
						...
						<div class="col-xs-12 ">
							<div class="mobile-bn3-h2 clearfix">
								<a href="#">
									<img src="../image/demo-mobile/banner/home3/banner-home34.jpg" alt="Image Client">
								</a>

							</div>
							<div class="mobile-bn3-h2 clearfix">
								<a href="index.php">
									<img src="../image/demo-mobile/banner/home3/banner-home35.jpg" alt="Image Client">
								</a>
							</div>
						</div>
